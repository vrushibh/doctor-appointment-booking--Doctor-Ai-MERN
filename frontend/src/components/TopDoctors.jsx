...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            <h1 className='text-3xl font-medium text-[#7E60BF]'>Top Doctors to Book</h1>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-[#F5EFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>more</button>
        </div>
